...
class Sales extends Secure_Controller
{
	...
	public function complete2()
	{
		...
		//Aqui se paremtriza para generar la boleta
		...
		if ($this->sale_lib->is_invoice_mode()) {
			...
			if ($data['sale_id_num'] == -1) {
				...
				$data['folio'] = $generar['body']['folio'];
				$data['boleta'] = $generar['body'];

				//cambiar a global en la configuracion	
				$datos = [
					'emisor' => $this->config->item('rutdte'),
					//'emisor' => '76955668',
					'dte' =>   $generar['body']['dte'],
	...
	public function test()
	{
		...
		// incluir autocarga de composer
		require('../vendor/autoload.php');
		$str = 'ajYng2hNw6V9wSvoFhVUSxgoxlq9mMon' . ':x';
		// echo base64_decode($str);
